<?php
    ...
    if($check_user_account_status == 0){
        if($page_access == 0 || !isset($_GET['id']) || empty($_GET['id'])){
            ...
            $payslip_ids = explode(',', $payslip_id);
        }
    }
    else{
                                        ...
                                        <div class="row">
                                            <?php
                                                ...
                                                foreach($payslip_ids as $payslip_id){
                                                    ...
                                                    if($i === $length){
                                                        $print_button = '<div class="d-print-none">
                                                                            <div class="float-end">
                                                    ...
                                                    echo '<div class="col-lg-12 page-break">
                                                            <div class="invoice-title">
                                                                <h4 class="float-end font-size-16"># '. $payslip_id .'</h4>
                                                                    <div class="mb-4">
                                                                        <img src="'. $company_logo .'" alt="company logo" style="max-height: 50px"/>
                                                                    </div>
                                                                </div>
                                                                <hr>
                                                                <div class="row">
                                                                    <div class="col-print-6">
                                                                        <address>'. $payslip_company_details .'</address>
                                                                    </div>
                                                                    <div class="col-print-6 text-end">
                                                                        <address class="mt-2 mt-sm-0">'. $generated_date .'</address>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-print-6">
                                                                        <address>'. $payslip_employee_details .'</address>
                                                                    </div>
                                                                    <div class="col-print-6 text-end">
                                                                        <address class="mt-2 mt-sm-0">'. $payslip_pay_run_details .'</address>
                                                                    </div>
                                                                </div>
                                                                <div class="py-0 mt-0">
