                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <a href="./import_template/import_attendance_record.csv" class="btn btn-success waves-effect waves-light" target="_blank">Download Template File</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <table class="table table-bordered mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>Leave blank if you wish to insert. If you want to update get the database ID of the attendance record.</td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">2</th>
                                                                <td>Employee ID</td>
