<?php
	...
	$add_holiday = $api->check_role_permissions($username, 152);
...
<html lang="en">
    ...
    <body data-sidebar="dark">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <?php
                                                            if($add_holiday > 0 || $delete_holiday > 0){

                                                                if($add_holiday > 0){
                                                                    echo '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-holiday"><i class="bx bx-plus label-icon"></i> Add</button>';
                                                                }

                                                                if($delete_holiday > 0){
                                                                    echo '<button type="button" class="btn btn-danger waves-effect btn-label waves-light d-none multiple" id="delete-holiday"><i class="bx bx-trash label-icon"></i> Delete</button>';
                                                                }
                                                            }
                                                        ?>
        ...
        <script src="assets/js/pages/holiday.js?v=<?php echo rand(); ?>"></script>
    </body>
</html>