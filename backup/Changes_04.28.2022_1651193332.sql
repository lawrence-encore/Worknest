...
INSERT INTO `tblpayrollsetting` VALUES (1,5,5,'TL-1194','UPD->LDAGULTO->2022-04-28 02:52:21');
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_payroll_setting`(IN setting_id INT, IN late_deduction_rate DOUBLE, IN early_leaving_deduction_rate DOUBLE, IN transaction_log_id VARCHAR(500), IN record_log VARCHAR(100))
BEGIN
	SET @setting_id = setting_id;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_payroll_setting`(IN setting_id INT, IN late_deduction_rate DOUBLE, IN early_leaving_deduction_rate DOUBLE, IN transaction_log_id VARCHAR(500), IN record_log VARCHAR(100))
BEGIN
	SET @setting_id = setting_id;
	SET @late_deduction_rate = late_deduction_rate;
	SET @early_leaving_deduction_rate = early_leaving_deduction_rate;
...
-- Dump completed on 2022-04-29  8:48:53
