<?php
    ...
    $page_access = $api->check_role_permissions($username, 328);
	$delete_pay_slip = $api->check_role_permissions($username, 329);
	$send_pay_slip = $api->check_role_permissions($username, 330);
	$print_pay_slip = $api->check_role_permissions($username, 331);
...
<html lang="en">
    ...
    <body data-sidebar="dark">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-grow-1 align-self-center">
                                                        <h4 class="card-title">Payroll Summary List</h4>
                                                    </div>
                                                    <div class="d-flex gap-2">
                                                        <?php
                                                             if($delete_pay_slip > 0 || $send_pay_slip > 0 || $print_pay_slip > 0){
                                                                if($delete_pay_slip > 0){
                                                    ...
                                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="filter-off-canvas" data-bs-backdrop="true" aria-labelledby="filter-off-canvas-label">
                                                        ...
                                                        <div class="offcanvas-body">
                                                            <div class="mb-3">
                                                                <p class="text-muted">Payroll Coverage Date</p>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="payroll-summary-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all">
        ...
        <script src="assets/js/pages/payroll-summary.js?v=<?php echo rand(); ?>"></script>
    </body>
</html>