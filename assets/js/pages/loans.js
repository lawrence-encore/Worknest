...
function initialize_click_events(){
    ...
    $(document).on('click','.view-loan',function() {
        ...
        generate_modal('loan details', 'Loan Details', 'R' , '1', '0', 'element', '', '0', username);
    });
    ...
    $(document).on('click','.update-loan',function() {
        ...
        generate_modal('loan form', 'Loan', 'LG' , '0', '1', 'form', 'loan-form', '0', username);
    });
...
function calculate_loan_maturity_date(){
    var transaction = 'calculate loan maturity date';
