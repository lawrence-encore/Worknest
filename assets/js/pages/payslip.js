...
function initialize_payslip_table(datatable_name, buttons = false, show_all = false){
    hide_multiple_buttons();
    
    var username = $('#username').text();
    var filter_branch = $('#filter_branch').val();
    var filter_department = $('#filter_department').val();
    var pay_run_id = $('#pay-run-id').text();
    var type = 'payslip table';
    var settings;
    ...
    if(buttons){
        settings = {
            'ajax': { 
                ...
                'method' : 'POST',
                'dataType': 'JSON',
                'data': {'type' : type, 'username' : username, 'pay_run_id' : pay_run_id, 'filter_branch' : filter_branch, 'filter_department' : filter_department},
                'dataSrc' : ''
            },
