<?php
    ...
    $page_access = $api->check_role_permissions($username, 284);
	$add_salary = $api->check_role_permissions($username, 285);
...
<html lang="en">
    ...
    <body data-sidebar="dark">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <?php
                                                            if($add_salary > 0 || $delete_salary > 0){

                                                                if($add_salary > 0){
                                                                    echo '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-salary"><i class="bx bx-plus label-icon"></i> Add</button>';
                                                                }

                                                                if($delete_salary > 0){
                                                                    echo '<button type="button" class="btn btn-danger waves-effect btn-label waves-light d-none multiple" id="delete-salary"><i class="bx bx-trash label-icon"></i> Delete</button>';
                                                                }
                                                            }
                                                        ?>
                                                    ...
                                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="filter-off-canvas" data-bs-backdrop="true" aria-labelledby="filter-off-canvas-label">
                                                        ...
                                                        <div class="offcanvas-body">
                                                            <div class="mb-3">
                                                                <p class="text-muted">Effectivity Date</p>

                                                                <div class="input-group mb-3" id="filter-start-date-container">
                                                                    <input type="text" class="form-control" id="filter_start_date" name="filter_start_date" autocomplete="off" data-date-format="m/dd/yyyy" data-date-container="#filter-start-date-container" data-provide="datepicker" data-date-autoclose="true" data-date-orientation="right" placeholder="Start Date" value="<?php echo date('01/01/Y'); ?>">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="salary-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all">
        ...
        <script src="assets/js/pages/salary.js?v=<?php echo rand(); ?>"></script>
    </body>
</html>