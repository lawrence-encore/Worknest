                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <?php
                                                                if($update_employee > 0){
                                                                    echo '<a class="dropdown-item" href="javascript: void(0);" data-employee-id="'. $employee_id .'" id="update-employee">Update Employee</a>';
                                                                }
                                                            ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                    <?php
                                                        if($view_employee_attendance > 0){
                                                            echo '<a class="nav-link mb-2 active" id="v-pills-attendance-tab" data-bs-toggle="pill" href="#v-pills-attendance" role="tab" aria-controls="v-pills-attendance" aria-selected="false">Attendance Record</a>';
                                                        }
                                                    ...
                                                    <?php
                                                        if($view_employee_attendance > 0){
                                                            if($add_employee_attendance > 0){
                                                                $add = '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-employee-attendance"><i class="bx bx-plus label-icon"></i> Add</button>';
                                                            }
                                                            else{
                                                                $add = '';
                                                            }
                                                                                    ...
                                                                                    <div class="offcanvas-body">
                                                                                        <div class="mb-3">
                                                                                            ...
                                                                                            <div class="input-group mb-3" id="filter-file-start-date-container">
                                                                                                <input type="text" class="form-control" id="filter_start_date" name="filter_start_date" autocomplete="off" data-date-format="m/dd/yyyy" data-date-container="#filter-file-start-date-container" data-provide="datepicker" data-date-autoclose="true" data-date-orientation="right" placeholder="Start Date" value="'. date('n/01/Y') .'">
                                                                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                                            </div>
                            
                                                                                            <div class="input-group" id="filter-file-end-date-container">
                                                                                                <input type="text" class="form-control" id="filter_end_date" name="filter_end_date" autocomplete="off" data-date-format="m/dd/yyyy" data-date-container="#filter-file-end-date-container" data-provide="datepicker" data-date-autoclose="true" data-date-orientation="right" placeholder="End Date" value="'. date('n/t/Y') .'">
                                                                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="mb-3">
                                                                                        ...
                                                                                        <div>
                                                                                            <button type="button" class="btn btn-primary waves-effect waves-light" id="apply-filter" data-bs-toggle="offcanvas" data-bs-target="#filter-attendance-record" aria-controls="filter-attendance-record">Apply Filter</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <?php
                                                                                        ...
                                                                                        <div class="offcanvas-body">
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <div class="input-group mb-3" id="filter-start-date-container">
                                                                                                    <input type="text" class="form-control" id="filter_start_date" name="filter_start_date" autocomplete="off" data-date-format="m/dd/yyyy" data-date-container="#filter-start-date-container" data-provide="datepicker" data-date-autoclose="true" data-date-orientation="right" placeholder="Start Date" value="'. date('n/01/Y') .'">
                                                                                                    <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                                                </div>

                                                                                                <div class="input-group" id="filter-end-date-container">
                                                                                                    <input type="text" class="form-control" id="filter_end_date" name="filter_end_date" autocomplete="off" data-date-format="m/dd/yyyy" data-date-container="#filter-end-date-container" data-provide="datepicker" data-date-autoclose="true" data-date-orientation="right" placeholder="End Date" value="'. date('n/t/Y') .'">
                                                                                                    <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <select class="form-control filter-select2" id="filter_leave_type">
                                                                                                    ...
                                                                                                    '. $api->generate_leave_type_options() .'
                                                                                                </select>
                                                                                            </div>
                                                                                            <div class="mb-3">
                                                                                            ...
                                                                                            <div>
                                                                                                <button type="button" class="btn btn-primary waves-effect waves-light" id="apply-filter" data-bs-toggle="offcanvas" data-bs-target="#filter-employee-leave" aria-controls="filter-employee-leave">Apply Filter</button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                        ...
                                                        if($view_employee_leave_entitlement > 0){
                                                            if($add_employee_leave_entitlement > 0){
                                                                $add = '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-employee-leave-entitlement"><i class="bx bx-plus label-icon"></i> Add</button>';
                                                            }
                                                            else{
                                                                $add = '';
                                                            }
                                                        ...
                                                        if($view_employee_file > 0){
                                                            if($add_employee_file > 0){
                                                                $add = '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-employee-file"><i class="bx bx-plus label-icon"></i> Add</button>';
                                                            }
                                                            else{
                                                                $add = '';
                                                            }
                                                        ...
                                                        if($view_employee_address > 0){
                                                            if($add_employee_address > 0){
                                                                $add = '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-employee-address"><i class="bx bx-plus label-icon"></i> Add</button>';
                                                            }
                                                            else{
                                                                $add = '';
                                                            }
                                                        ...
                                                        if($view_emergency_contact > 0){
                                                            if($add_emergency_contact > 0){
                                                                $add = '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-emergency-contact"><i class="bx bx-plus label-icon"></i> Add</button>';
                                                            }
                                                            else{
                                                                $add = '';
                                                            }
                                                        ...
                                                        if($view_employee_social > 0){
                                                            if($add_employee_social > 0){
                                                                $add = '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-employee-social"><i class="bx bx-plus label-icon"></i> Add</button>';
                                                            }
                                                            else{
                                                                $add = '';
                                                            }
