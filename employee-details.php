                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                    <a class="nav-link mb-2 active" id="v-pills-employee-information-tab" data-bs-toggle="pill" href="#v-pills-employee-information" role="tab" aria-controls="v-pills-employee-information" aria-selected="false">Employee Details</a>
                                                    <?php
                                                        if($view_employee_attendance > 0){
                                                            echo '<a class="nav-link mb-2" id="v-pills-attendance-tab" data-bs-toggle="pill" href="#v-pills-attendance" role="tab" aria-controls="v-pills-attendance" aria-selected="false">Attendance Record</a>';
                                                        }
                                                ...
                                                <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                                                    ...
                                                    <?php
                                                        if($view_employee_attendance > 0){
                                                            ...
                                                            echo '<div class="tab-pane fade" id="v-pills-attendance" role="tabpanel" aria-labelledby="v-pills-attendance-tab">
                                                                    <div class="row mb-4">
                                                                        <div class="col-md-12">
                                                                            <div class="d-flex align-items-start">
                                                                                <div class="flex-grow-1 align-self-center">
