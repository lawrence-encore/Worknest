...
<html lang="en">
    ...
    <body data-sidebar="dark">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="notification-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all">Notification</th>
                                                            <th class="all">Notification From</th>
                                                            <th class="all">Notification Date</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody></tbody>
                                                </table>
        ...
        <script src="assets/js/pages/notification.js?v=<?php echo rand(); ?>"></script>
    </body>
</html>