                                                        ...
                                                        <?php
                                                            if($approve_attendance_creation > 0 || $reject_attendance_creation > 0 || $cancel_attendance_creation > 0){
                                                                ...
                                                                if($approve_attendance_creation > 0){
                                                                    echo '<button type="button" class="btn btn-success waves-effect btn-label waves-light d-none multiple-attendance-approve" id="approve-attendance-creation"><i class="bx bx-check label-icon"></i> Approve</button>';
                                                                }
