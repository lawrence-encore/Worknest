<?php
	...
	$delete_leave = $api->check_role_permissions($username, 122);
                                                    ...
                                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="filter-off-canvas" data-bs-backdrop="true" aria-labelledby="filter-off-canvas-label">
                                                        ...
                                                        <div class="offcanvas-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control select2" id="filter_leave_type">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control select2" id="filter_leave_status">
                                                                    <option value="1">Approved</option>
                                                                    <option value="4">Approved (System Generated)</option>
