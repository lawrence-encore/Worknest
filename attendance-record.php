<?php
    ...
    $page_access = $api->check_role_permissions($username, 160);
	$add_attendance_record = $api->check_role_permissions($username, 161);
                                                        ...
                                                        <div class="offcanvas-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group mb-3" id="filter-file-start-date-container">
                                                                    <input type="text" class="form-control" id="filter_start_date" name="filter_start_date" autocomplete="off" data-date-format="m/dd/yyyy" data-date-container="#filter-file-start-date-container" data-provide="datepicker" data-date-autoclose="true" data-date-orientation="right" placeholder="Start Date">
                                                                    <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                </div>

                                                                <div class="input-group" id="filter-file-end-date-container">
                                                                    <input type="text" class="form-control" id="filter_end_date" name="filter_end_date" autocomplete="off" data-date-format="m/dd/yyyy" data-date-container="#filter-file-end-date-container" data-provide="datepicker" data-date-autoclose="true" data-date-orientation="right" placeholder="End Date">
                                                                    <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                </div>
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control select2" id="filter_time_in_behavior">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control select2" id="filter_time_out_behavior">
