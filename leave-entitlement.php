<?php
    ...
    $api = new Api;
    $page_title = 'Leave Entitlement';

    $page_access = $api->check_role_permissions($username, 109);
	$add_leave_entitlement = $api->check_role_permissions($username, 110);
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="leave-entitlement-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all">
