                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <a href="./import_template/import_leave_entitlement.csv" class="btn btn-success waves-effect waves-light" target="_blank">Download Template File</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <th scope="row">1</th>
                                                                <td>Leave Entitlement ID</td>
                                                                <td>Text</td>
                                                                <td>50</td>
                                                                <td><span class="badge bg-info">No</span></td>
                                                                <td>Leave blank if you wish to insert. If you want to update get the database ID of the leave entitlement.</td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">2</th>
                                                                <td>Employee ID</td>
                                                            ...
                                                            <tr>
                                                                <th scope="row">4</th>
                                                                <td>Number of Leave</td>
                                                                <td>Number</td>
                                                                <td>11</td>
                                                                <td><span class="badge bg-warning">Yes</span></td>
                                                                <td>Minimum value is one (1).</td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">5</th>
                                                                <td>Start Date</td>
