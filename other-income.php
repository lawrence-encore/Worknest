<?php
    ...
    $page_access = $api->check_role_permissions($username, 321);
	$add_other_income = $api->check_role_permissions($username, 322);
...
<html lang="en">
    ...
    <body data-sidebar="dark">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Manage Other Income</a></li>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-grow-1 align-self-center">
                                                        <h4 class="card-title">Other Income List</h4>
                                                    </div>
                                                    <div class="d-flex gap-2">
                                                        <?php
                                                            if($add_other_income > 0 || $delete_other_income > 0){

                                                                if($add_other_income > 0){
                                                                    echo '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-other-income"><i class="bx bx-plus label-icon"></i> Add</button>';
                                                                }

                                                                if($delete_other_income > 0){
                                                                    echo '<button type="button" class="btn btn-danger waves-effect btn-label waves-light d-none multiple" id="delete-other-income"><i class="bx bx-trash label-icon"></i> Delete</button>';
                                                                }
                                                            }
                                                        ?>
                                                    ...
                                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="filter-off-canvas" data-bs-backdrop="true" aria-labelledby="filter-off-canvas-label">
                                                        ...
                                                        <div class="offcanvas-body">
                                                            ...
                                                            <div class="mb-3">
                                                                <p class="text-muted">Other Income Type</p>

                                                                <select class="form-control filter-select2" id="filter_other_income_type">
                                                                    <option value="">All Other Income Type</option>
                                                                    <?php echo $api->generate_other_income_type_options(); ?>
                                                                </select>
                                                            </div>
                                                            <div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="other-income-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all">
        ...
        <script src="assets/js/pages/other-income.js?v=<?php echo rand(); ?>"></script>
    </body>
</html>